...
mixin _$FilterStore on FilterStoreBase, Store {
  ...
  late final _$shopIdsAtom =
      Atom(name: 'FilterStoreBase.shopIds', context: context);

  @override
  List<int> get shopIds {
    _$shopIdsAtom.reportRead();
    return super.shopIds;
  }

  @override
  set shopIds(List<int> value) {
    _$shopIdsAtom.reportWrite(value, super.shopIds, () {
      super.shopIds = value;
    });
  }
  ...
  late final _$addToShopListAsyncAction =
      AsyncAction('FilterStoreBase.addToShopList', context: context);

  @override
  Future<void> addToShopList({required int serId}) {
    return _$addToShopListAsyncAction
        .run(() => super.addToShopList(serId: serId));
  }

  late final _$removeFromShopListAsyncAction =
      AsyncAction('FilterStoreBase.removeFromShopList', context: context);

  @override
  Future<void> removeFromShopList({required int serId}) {
    return _$removeFromShopListAsyncAction
        .run(() => super.removeFromShopList(serId: serId));
  }
