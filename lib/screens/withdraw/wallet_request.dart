              ...
              child: AnimatedScrollView(
                ...
                children: [
                  ...
                  AppTextField(
                    ...
                    decoration: inputDecoration(context, hintText: language.eg3000, prefix: const Text("\$ ")),
                    ...
                    validator: (value) {
                      ...
                      final enteredAmount = num.tryParse(value.toString()) ?? 0;
                      final availableBalance = widget.availableBalance.validate();
                      ...
                      if (availableBalance == 0) {
                        return "Withdrawal is not allowed as your wallet balance is 0.";
                      } else if (enteredAmount > availableBalance) {
                        return "${language.pleaseAddLessThanOrEqualTo} ${availableBalance.toPriceFormat()}";
                      }
                  ...
                  if (isWithdrawMethodIsBank) ...[
                    ...
                    Row(
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            const AddBankScreen().launch(context).then((value) {
                              if (value.isNotEmpty) {
                                if (value[0]) {
                                  init(value[1]);
                                  setState(() {});
