              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    2.width,
                    if (widget.chatItemData.isMe.validate()) !widget.chatItemData.isMessageRead.validate()
                            ? const Icon(Icons.done, size: 12, color: Colors.white60)
                            : const Icon(Icons.done_all, size: 12, color: Colors.white60) else const Offstage()
                  ],
                ),
              ],
            )
                  ...
                  return GestureDetector(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        if (file.contains(RegExp(r'\.jpeg|\.jpg|\.gif|\.png|\.bmp'))) CachedImageWidget(
                                url: file,
                                height: 80,
                                width: 80,
                                fit: BoxFit.cover,
