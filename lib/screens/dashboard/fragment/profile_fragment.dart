                ...
                children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            decoration: boxDecorationDefault(borderRadius: const BorderRadius.vertical(bottom: Radius.circular(8)), color: primaryColor),
                            child: Row(
                              children: [
                  ...
                  Observer(builder: (context) {
                    return SettingSection(
                      ...
                      headingDecoration: boxDecorationDefault(color: context.primaryColor.withValues(alpha: 0.1), borderRadius: const BorderRadiusDirectional.vertical(top: Radius.circular(16))),
                      divider: const Offstage(),
                      headerPadding: const EdgeInsets.only(bottom: 14, right: 14, left: 16, top: 14),
                      items: [
                        ...
                        SettingItemWidget(
                          decoration: boxDecorationDefault(color: context.cardColor, borderRadius: const BorderRadiusDirectional.vertical(bottom: Radius.circular(0))),
                          leading: ic_referral.iconImage(size: SETTING_ICON_SIZE),
                          title: language.lblReferralAndLoyalty,
                          titleTextStyle: boldTextStyle(size: 12),
                          trailing: trailing,
                          padding: const EdgeInsets.only(top: 20, left: 16, right: 16),
                          onTap: () {
                            doIfLoggedIn(context, () {
                              const ReferralAndLoyaltyScreen().launch(context);
                            });
                          },
                        ),
                        SettingItemWidget(
                        ...
                        SettingItemWidget(
                          ...
                          titleTextStyle: boldTextStyle(size: 12),
                          trailing: trailing,
                          padding: appStore.isLoggedIn ? EdgeInsets.only(bottom: appStore.isLoggedIn ? 0 : 16, top: 20, left: 16, right: 16) : const EdgeInsets.only(bottom: 16, right: 16, left: 16, top: 20),
                          onTap: () async {
                            doIfLoggedIn(context, () {
                        ...
                        if (appStore.isLoggedIn && rolesAndPermissionStore.helpDeskList)
                          SettingItemWidget(
                            ...
                            padding: const EdgeInsets.only(bottom: 16, right: 16, left: 16, top: 20),
                            onTap: () {
                        ...
                        SettingItemWidget(
                          ...
                          highlightColor: Colors.transparent,
                          splashColor: Colors.transparent,
                          padding: const EdgeInsets.only(bottom: 6, right: 16, left: 16, top: 6),
                          onTap: () {},
                        ),
                      ],
                    ).paddingAll(16);
                  ...
                  SettingSection(
                    ...
                    items: [
                      ...
                      if (appConfigurationStore.helplineNumber.isNotEmpty)
                        SettingItemWidget(
                          decoration: !appStore.isLoggedIn
                              ? boxDecorationDefault(color: context.cardColor, borderRadius: const BorderRadiusDirectional.vertical(bottom: Radius.circular(0)))
                              : boxDecorationDefault(color: context.cardColor, borderRadius: const BorderRadiusDirectional.vertical(bottom: Radius.circular(16))),
                      ...
                      SettingItemWidget(
                        decoration: !appStore.isLoggedIn ? boxDecorationDefault(color: context.cardColor, borderRadius: const BorderRadiusDirectional.vertical(bottom: Radius.circular(16))) : boxDecorationDefault(color: context.cardColor),
                  ...
                  SettingSection(
                    ...
                    headingDecoration: boxDecorationDefault(color: redColor.withValues(alpha: 0.08), borderRadius: const BorderRadiusDirectional.vertical(top: Radius.circular(16))),
                    divider: const Offstage(),
                    headerPadding: const EdgeInsets.only(bottom: 14, right: 14, left: 16, top: 14),
                    items: [
                      8.height,
