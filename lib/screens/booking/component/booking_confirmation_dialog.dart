...
import 'loyalty_points_earned.dart';
...
class BookingConfirmationDialog extends StatefulWidget {
  ...
  const BookingConfirmationDialog({required this.data, required this.bookingId, this.bookingPrice, this.selectedPackage, this.bookingDetailResponse, this.earnPoints});
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if ((widget.earnPoints ?? 0) != 0 || (widget.selectedPackage?.earnPoints.validate() ?? 0) != 0)
                  PointsEarnedCard(
                    points: widget.earnPoints ?? widget.selectedPackage?.earnPoints.validate(),
                  ).paddingTop(16),
                16.height,
                Row(
                  children: [
