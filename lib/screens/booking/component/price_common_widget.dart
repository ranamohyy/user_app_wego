          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                /// Loyalty points discount (if used for this booking for package)
                if (bookingDetail.redeemedDiscount.validate() != 0)
                  Column(
                    children: [
                      16.height,
                      Row(
                        children: [
                          Row(
                            children: [
                              ...
                              if (bookingDetail.redeemedPoints.validate() != 0)
                                Text(
                                  " (${bookingDetail.redeemedPoints.validate()} pts)",
                                  style: boldTextStyle(color: primaryColor, size: 14),
                                ).expand(),
                            ],
                          ).expand(),
                          PriceWidget(
                            price: bookingDetail.redeemedDiscount.validate(),
                            color: Colors.green,
                            isBoldText: true,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                            ...
                            Marquee(
                              child: Row(
                                children: [
                                  ...
                                  PriceWidget(
                                    price: (bookingDetail.bookingType.validate() == BOOKING_TYPE_USER_POST_JOB) ? bookingDetail.amount.validate() : bookingDetail.finalTotalServicePrice.validate(),
                                    isBoldText: true,
                ...
                /// Loyalty points discount (if used for this booking)
                if (bookingDetail.redeemedDiscount.validate() != 0)
                  Column(
                    children: [
                      Row(
                ...
                if (serviceDetail.isAdvancePayment &&
                    ...
                    bookingDetail.status.validate().toLowerCase() != BOOKING_STATUS_CANCELLED)
                  Column(
                    children: [
                      16.height,
                      Row(
                        ...
                        children: [
                          TextIcon(
                            ...
                            suffix: bookingDetail.status == BookingStatusKeys.complete && bookingDetail.paymentStatus == SERVICE_PAYMENT_STATUS_PAID
                                ? const Offstage()
                                : Icon(Icons.info_outline_rounded, size: 20, color: context.primaryColor),
                            expandedText: true,
                            maxLine: 3,
                            onTap: () {
                              showModalBottomSheet(
