...
import 'package:booking_system_flutter/screens/find_driver/components/find_driver_button.dart';
...
class _BookingDetailScreenState extends State<BookingDetailScreen>
      ...
      children: [
        Column(
          children: [
            ...
            // Find Driver Button - Show after booking is completed or accepted
            if (_shouldShowFindDriverButton(snap.data!))
              FindDriverButton(bookingDetail: snap.data!)
  ...
  bool _shouldShowFindDriverButton(BookingDetailResponse bookingResponse) {
    final status = bookingResponse.bookingDetail?.status;
    // Show Find Driver button for accepted, ongoing, in_progress, or completed bookings
    return status == BookingStatusKeys.accept ||
