...
class PayPalScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String methodName = PaymentMethod.paypal.displayName;
    return Scaffold(
      appBar: AppBar(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.payment, size: 64, color: primaryColor),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  // TODO: Integrate PayPalService when booking context is available
