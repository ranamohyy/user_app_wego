...
const grey300Color = Color(0xFFE0E0E0); // grey[300]
const amberColor = Color(0xFFFFC107); // Colors.amber

const shopColor= Color(0xFF1C1E33);
const maxPointColor = Color(0xFFD8D8FF);