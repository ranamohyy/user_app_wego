...
class BookingServiceKeys {
  ...
  static String bookingDate = 'booking_date';
  static String bookingSlot = 'booking_slot';
  static String bookingDay = 'booking_day';
...
class BookingStatusKeys {
  ...
  static const String waitingAdvancedPayment = "waiting";
}
...
class ShopKey {
  static String shopId = 'shop_id';
  static String shopName = 'shop_name';
  static String shopAddress = 'shop_address';
  static String shopCity = 'shop_city';
  static String shopState = 'shop_state';
  static String shopCountry = 'shop_country';
  static String shopEmail = 'email';
  static String shopContactNumber = 'contact_number';
  static String shopImage = 'shop_image';
}