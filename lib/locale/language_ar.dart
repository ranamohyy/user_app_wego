...
class LanguageAr extends BaseLanguage {
  ...
  @override
  String get lblAllShop => 'جميع المتاجر';

  @override
  String get lblShopDetails => 'تفاصيل المتجر';

  @override
  String get lblServicesList => 'قائمة الخدمات';

  @override
  String get lblShopAddress => 'عنوان المتجر';

  @override
  String get lblAtShop => 'في المتجر';

  @override
  String get lblNoShopsFound => 'لم يتم العثور على أي متاجر';

  @override
  String get lblShopName => 'اسم المتجر';

  @override
  String get lblAboutShop => 'حول المتجر';

  @override
  String get contactNumber => 'رقم الاتصال';

  @override
  String get lblViewLess => 'عرض أقل';

  @override
  String get lblServices => 'خدمات';

  @override
  String shopsService(String shopName) => "جميع الخدمات متوفرة في $shopName";
  ...
  @override
  String lblProvidersShops(String providerName) => 'متاجر $providerName\'s';

  @override
  String lblShopsOffer(String serviceName) => 'المتاجر التي تقدم $serviceName';

  @override
  String get lblZone => 'منطقة';

  @override
  String get completeThisBookingToEarn => 'أكمل هذا الحجز لترب';

  @override
  String get redeemPointsOnNextBooking => 'استبدل نقاطك في الحجز القادم للحصول على خصومات!';

  @override
  String get inviteNow => 'ادعُ الآن';

  @override
  String get referFriendsAndEarnLoyaltyPoints => 'أحِل أصدقاءك واكسب نقاط الولاء';

  @override
  String get inviteYourFriendsToTryServices => 'ادعُ أصدقاءك لتجربة خدماتنا وسَتكسبان مكافآت فورية معًا';

  @override
  String get lblReferralAndLoyalty => 'الإحالة والولاء';

  @override
  String get lblYourReferralCode => 'رمز الإحالة الخاص بك';

  @override
  String get lblShare => 'مشاركة';

  @override
  String shareYourPromoCode(String referrerPoints,String referredPoints) => 'شارك رمز العرض الخاص بك مع صديق وستحصلان أنتما الاثنان على $referrerPoints نقاط ولاء';

  @override
  String get copyYourCodeAndShare => '• انسخ رمزك وشاركه مع أصدقائك';

  @override
  String get lblAvailableLoyaltyPoints => 'نقاط الولاء المتاحة';

  @override
  String get lblHistory => "السجل";
  @override
  String get referralCodeIsCopied =>' تم نسخ رمز الإحالة';
  @override
  String get howItWorks => 'كيف تعمل';
  @override
  String get sendAnotherReferral => 'أرسل إحالة أخرى';

  @override
  String get lblRedeemPoints => 'استبدال النقاط';

  @override
  String referralShareMessage(String referralCode, String referralUrl) =>
      """هل تحتاج إلى خدمات منزلية موثوقة؟
انضم إلى تطبيق خدمات الحرفيين واحصل على مساعدة سريعة وموثوقة في أي وقت!
استخدم رمز الإحالة الخاص بي $referralCode لتحصل على نقاط ولاء عند التسجيل.
👉 حمل التطبيق الآن: $referralUrl""";
  @override
  ...
  // Find Driver Feature
  @override
  String get findDriver => 'ابحث عن سائق';

  @override
  String get trackDriver => 'تتبع السائق';

  @override
  String get driversAvailable => 'سائقون متاحون';
  ...
  @override
  String get dropLocation => 'موقع التسليم';

  @override
  String get pickupLocationRequired => 'موقع الاستلام مطلوب';

  @override
  String get dropLocationRequired => 'موقع التسليم مطلوب';

  @override
  String get driverRequested => 'تم طلب السائق';

  @override
  String get driverAccepted => 'تم قبول السائق';
  ...
  @override
  String get trackingDriverLocation => 'جاري تتبع موقع السائق...';
